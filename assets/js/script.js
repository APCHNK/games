...
burgerCtr.addEventListener("click", function () {
  ...
  this.style.display = "none"; // Устанавливаем display: none; для #burger-menu
});
////////////////////////////////////
...
burgerCtr.addEventListener("click", function () {
  ...
  menuCtr.classList.add("show_mobile_menu");
});

cancelButton.addEventListener("click", function () {
  burgerCtr.style.display = "block"; // Устанавливаем display: block; для #burger-menu
  menuCtr.classList.remove("show_mobile_menu"); // Убираем класс "active" у #mobile-menu
});
